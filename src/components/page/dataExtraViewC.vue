	...
	<div class="table">
	  	...
	  	<div class="itemcc">
	  			...
	  			<el-collapse v-model="activeNames" @change="handleChange">
					  ...
					  <el-collapse-item title="全部分类" name="1">
					    <div class="itlist">
					    	...
					    	<router-link to="/dataExtraViewA"><p ><span>音频视频</span> <em>(871)</em></p></router-link>
					    	<router-link to="/dataExtraViewC"><p  class="active"><span>文档</span> <em>(63782)</em></p></router-link>
	  		...
	  		<div class="right">
	  			<div class="tabcc">
	  				<ul>
	  					<li class="active"><a href="javascript:void(0)"><span>全部</span> <em>(772)</em></a></li>
	  					<li><a href="javascript:void(0)"><span>Word</span> <em>(672)</em></a></li>
	  					<li><a href="javascript:void(0)"><span>Excel</span> <em>(22)</em></a></li>
	  					<li><a href="javascript:void(0)"><span>PPT</span> <em>(18)</em></a></li>
	  					<li><a href="javascript:void(0)"><span>TXT</span> <em>(34)</em></a></li>
	  					<li><a href="javascript:void(0)"><span>PDF</span> <em>(20)</em></a></li>
	  					<li><a href="javascript:void(0)"><span>CAJ</span> <em>(16)</em></a></li>
	  				</ul>
	  			</div>
	  			<el-table :data="tableDataV" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
						...
						<el-table-column prop="dataSet" align="center" label="数据集名称" width="160">
							<template slot-scope="scope">
								<router-link to="/dataFileShow">
									<span>
									<i v-if="scope.row.icoType === 'video-camera'"  class="fa fa-video-camera"></i>
									<i v-else-if="scope.row.icoType === 'file-excel-o'"  class="fa fa-file-excel-o"></i>
									<i v-else-if="scope.row.icoType === 'file-pdf-o'"  class="fa fa-file-pdf-o"></i>
									<i v-else-if="scope.row.icoType === 'file-powerpoint-o'"  class="fa fa-file-powerpoint-o"></i>
									<i v-else-if="scope.row.icoType === 'file-word-o'"  class="fa fa-file-word-o"></i>
