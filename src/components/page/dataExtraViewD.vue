	  		...
	  		<div class="left">
	  			<el-collapse v-model="activeNames" @change="handleChange">
					  ...
					  <el-collapse-item title="全部分类" name="1">
					    <div class="itlist">
					    	<router-link to="/dataExtraViewD"><p class="active"><span>图片</span> <em>(3883)</em></p></router-link>
	  		...
	  		<div class="right">
	  			<div>
	  				<dl>
	  					<dt>
	  						<span>2019年</span>
	  						<span>共 <em>200</em> 张</span>
	  					</dt>
	  					<dd>
	  						<ul>
	  							<li>
	  								<router-link to="/dataPicShow">
	  									<div class="pic"><img src="../../assets/pic009.jpg" alt=""></div>
			  								<p>优势.jpg</p>
			  								<div class="sstag">
			  									<el-tag size="mini" closable>已标注</el-tag>
